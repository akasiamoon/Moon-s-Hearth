...
const myRecipes = [
    ...
    { title: "🍈 Elsweyr Melon-Jelly", description: "A shimmering, translucent dessert favored by Khajiiti travelers for its cooling properties in the desert heat.", ingredients: ["2 cups honeydew or cantaloupe juice, strained", "Honey to sweeten", "Unflavored gelatin or agar-agar", "Mint leaves for garnish"], instructions: "Dissolve the honey and thickener into the warmed juice. Pour into shallow glass bowls and let set in a cool cellar until firm. Garnish with mint before serving." },
...
const myTeas = [
    ...
    { title: "Khajiit 'Moon-Sugar' Chai", icon: "🐯", brew: "Steep 5 mins at 212°F", description: "A spicy, invigorating black tea with ginger and cinnamon. Perfect for staying alert on the road during delivery runs." },
    { title: "Altmer 'Crystal Tower' White Tea", icon: "💎", brew: "Steep 2 mins at 175°F", description: "A delicate, high-caffeine silver needle tea for mental clarity and precision during Unity or Python coding." },
    { title: "Nord 'Meadow-Sweet' Infusion", icon: "🏔️", brew: "Steep 6 mins at 200°F", description: "A wild-crafted blend of peppermint and red clover to bolster physical stamina through the Tennessee frost." },
    { title: "Road-Warrior's Yerba Mate", icon: "🧉", brew: "Steep 5 mins at 165°F", description: "A potent, earthy stimulant. Provides a steady, jitter-free energy kick for long days behind the wheel." },
    { title: "Matcha Focus Fuel", icon: "🍵", brew: "Whisk in 175°F water", description: "Pure powdered green tea. High in L-theanine for calm alertness while navigating traffic or tracking orders." },
    { title: "Iron Goddess Oolong", icon: "🐉", brew: "Steep 3 mins at 190°F", description: "Ti Kuan Yin Oolong. Known for sharpening the mind—perfect for troubleshooting complex CSS or Python logic." },
    { title: "Ginkgo & Gotu Kola Infusion", icon: "🌿", brew: "Steep 10 mins at 212°F", description: "A non-caffeinated herbal blend specifically designed to support memory and cognitive endurance during long dev sessions." },
    { title: "Crimson Berry Spark", icon: "🍓", brew: "Steep 5 mins at 212°F", description: "A vibrant blend of hibiscus, rosehips, and dried berries. High in Vitamin C and naturally sweet for the kids." },
    { title: "Rooibos 'Lion's Mane' Vanilla", icon: "🦁", brew: "Steep 7 mins at 212°F", description: "Smooth, red bush tea that tastes like a treat. Great for staying hydrated during homeschooling without any caffeine jitters." },
    { title: "White Peony Skin Shield", icon: "🌸", brew: "Steep 3 mins at 175°F", description: "A minimally processed white tea packed with antioxidants that help protect skin cells and maintain vibrant ink." },
    { title: "Nettle & Oatstraw Tonic", icon: "🌾", brew: "Steep 15 mins at 212°F", description: "A mineral-rich infusion that supports overall skin health and resilience from the inside out." },
    { title: "Midnight Lapsang Souchong", icon: "🖤", brew: "Steep 4 mins at 212°F", description: "A 'gothic' tea. Pine-smoked black tea leaves create a campfire-scented brew that matches a rainy Tennessee evening." },
    { title: "Velvet Cacao Pu-erh", icon: "🍫", brew: "Steep 5 mins at 212°F", description: "A deep, fermented dark tea with a rich chocolate aroma. Indulgent, grounding, and perfect for the late-night stillness." }
];

const myApothecary = [
    { title: "Vibrant Ink Protectant Salve", icon: "🏺", description: "A deeply nourishing balm to protect and preserve skin artwork, keeping lines sharp and colors true.", ingredients: "Beeswax, Shea Butter, Calendula Oil, Vitamin E", instructions: "Melt the wax and butter over a low hearth. Remove from heat, stir in the oils, and pour into a glass tin to set." },
    { title: "Soothe-and-Seal Tattoo Wash", icon: "🧼", description: "A gentle, antimicrobial cleanser for fresh ink that prevents irritation without stripping moisture.", ingredients: "Liquid Castille Soap, Distilled Water, Lavender Essential Oil, Tea Tree Oil", instructions: "Dilute the soap with water (1:3 ratio). Add 5 drops of each oil. Shake gently before use." },
    { title: "Dasher’s Focus Temple Balm", icon: "🧠", description: "A cooling, aromatic balm to rub on temples during long delivery shifts to combat road fatigue.", ingredients: "Coconut Oil, Peppermint Oil, Rosemary Oil, Eucalyptus Oil", instructions: "Blend oils into softened coconut oil. Apply to pressure points for an instant mental 'refresh'." },
    { title: "Anti-Traffic Tension Roll-On", icon: "🚗", description: "A portable oil blend to soothe the nerves during heavy traffic or difficult delivery windows.", ingredients: "Jojoba Oil, Bergamot Essential Oil, Frankincense Oil", instructions: "Combine in a 10ml roller bottle. Apply to wrists and breathe deeply when road stress rises." },
    { title: "Hearth-Bound Muscle Soak", icon: "🛁", description: "A powerful recovery salt blend for tired legs and backs after a day of driving through Adamsville.", ingredients: "Epsom Salts, Pink Himalayan Salt, Ginger Powder, Juniper Berry Oil", instructions: "Mix salts and powder in a jar. Add 10 drops of oil. Dissolve 1 cup into a hot bath for deep restoration." },
    { title: "Quiet-Mind Pillow Spray", icon: "💤", description: "A gentle mist to transition the apprentices from lessons to sleep, calming restless energy.", ingredients: "Witch Hazel, Distilled Water, Chamomile Oil, Clary Sage Oil", instructions: "Combine in a dark glass spray bottle. Lightly mist bed linens ten minutes before sleep." },
    { title: "Gilded Immunity Elderberry Syrup", icon: "🍷", description: "A daily tonic to bolster the family’s defenses against the Tennessee seasonal changes.", ingredients: "Dried Elderberries, Cinnamon Sticks, Cloves, Fresh Ginger, Raw Honey", instructions: "Simmer berries and spices in water for 45 mins. Strain, let cool slightly, and stir in honey until thick." },
    { title: "Focus-Fire Study Mist", icon: "📚", description: "A bright, clarifying room spray to use in the homeschooling area to help the children focus on their tasks.", ingredients: "Distilled Water, Lemon Oil, Rosemary Oil, Peppermint Oil", instructions: "Combine in a spray bottle. Shake and spritz the air at the start of a new curriculum quest." },
    { title: "Blonde-Streak Brightening Rinse", icon: "✨", description: "A natural rinse to keep your blonde streak vibrant and clear of brassy tones.", ingredients: "Strongly brewed Chamomile tea, Lemon juice, Apple Cider Vinegar", instructions: "Mix cooled tea with a splash of juice and vinegar. Use as a final rinse after washing hair." },
    { title: "Velvet Midnight Hair Mask", icon: "🌙", description: "A deep conditioning treatment for your graduated bob, maintaining that sleek, gothic shine.", ingredients: "Argan Oil, Avocado Oil, Rosemary Essential Oil", instructions: "Warm the oils slightly. Massage through damp hair, focusing on the ends. Wrap in a warm towel for 20 mins before washing." },
    { title: "Neon-Flora Lip Glaze", icon: "💄", description: "A vibrant, Lisa Frank-inspired tinted balm that provides a pop of color with apothecary-grade hydration.", ingredients: "Beeswax, Coconut Oil, Beetroot Powder (for tint), Sweet Orange Oil", instructions: "Melt wax and oil. Stir in beetroot powder until the desired pink/red is achieved. Add oil and pour into tins." },
    { title: "Gothic Velvet Facial Serum", icon: "🖤", description: "A luxurious, dark-themed oil for nighttime skin repair, matching your midnight aesthetics.", ingredients: "Rosehip Seed Oil, Argan Oil, Frankincense Resin, Dried Rose Petals", instructions: "Infuse petals in oils for one full moon cycle. Strain and apply 3 drops before sleep for a velvet finish." },
    { title: "Iron-Heart Blade Oil", icon: "⚔️", description: "A protective oil to prevent rust on your workshop tools and kitchen knives.", ingredients: "Mineral Oil, Clove Essential Oil", instructions: "Mix a few drops of clove oil into the mineral oil. Apply a thin layer to metal surfaces after cleaning to ward off dampness." },
    { title: "Scribe’s Screen & Glass Cleanser", icon: "🖥️", description: "A streak-free, gentle cleaner for your development monitors and tablets.", ingredients: "Distilled Water, Isopropyl Alcohol (70%), 1 drop Dish Soap", instructions: "Mix in a fine-mist spray bottle. Spray onto a microfiber cloth (never the screen!) and wipe in a circular motion." },
    { title: "Storm-Soothe Chest Rub", icon: "🌬️", description: "A warming, vapor-style rub for the damp chill of an ice storm or rainy season.", ingredients: "Olive Oil, Beeswax, Eucalyptus Oil, Camphor Oil", instructions: "Melt oil and wax. Stir in essential oils as it cools. Massage onto chest and back to open the airways." },
    { title: "Hearth-Fire Hand Salve", icon: "🧤", description: "A heavy-duty repair cream for dry, cracked skin caused by cold winter air and frequent washing.", ingredients: "Lanolin, Coconut Oil, Honey, Calendula Petals", instructions: "Infuse oil with petals, strain, then whisk in lanolin and honey until a thick, buttery paste forms." },
    { title: "Fresh-Air Car Diffuser Blend", icon: "🌬️", description: "A bright, deodorizing blend to keep the 'Dasher-mobile' smelling like a sanctuary, even after food deliveries.", ingredients: "Lemon Oil, Grapefruit Oil, Pine Oil", instructions: "Drop onto a hanging clay ornament or wooden clip. The citrus cuts through food odors while the pine grounds the energy." },
    { title: "Road-Steady Eye Compress", icon: "👁️", description: "A cooling treatment for tired, strained eyes after hours of night driving or coding.", ingredients: "Dried Cornflowers or Green Tea bags, Chilled Water", instructions: "Steep the herbs/tea, then chill the liquid. Soak cotton pads and rest over closed eyes for 10 minutes." },
    { title: "Gothic Rose Floor Wash", icon: "🥀", description: "A traditional cleansing wash to refresh the energy of the home and leave a faint, dark floral scent.", ingredients: "Hot Water, White Vinegar, Rose Water, Sea Salt", instructions: "Add ingredients to your mop bucket. The salt and vinegar 'clear' the space, while the rose water invites beauty." },
    { title: "Lisa Frank 'Electric' Room Spray", icon: "🌈", description: "A high-vibe, colorful scent profile that makes the homeschooling area feel energetic and fun.", ingredients: "Witch Hazel, Orange Oil, Ylang Ylang, Vanilla Extract", instructions: "Combine in a spray bottle. It smells like 'bright sunshine and candy,' perfect for lifting the mood during math lessons." },
    { title: "Minor Burn Butter", icon: "🔥", description: "A cooling balm for minor kitchen mishaps or small workshop singes.", ingredients: "Aloe Vera Gel, Lavender Oil, Vitamin E Oil", instructions: "Whisk together until emulsified. Keep in the refrigerator for an extra cooling 'ice-spell' effect." },
    { title: "The 'Bruise-Be-Gone' Liniment", icon: "🩹", description: "Speeds up the healing of bumps and bruises for active apprentices and busy parents.", ingredients: "Witch Hazel, Arnica Flowers (Infused), St. John’s Wort Oil", instructions: "Soak arnica in witch hazel for 2 weeks. Strain and mix with oil. Rub gently onto bruised areas." },
    { title: "Obsidian Velvet Lip Stain", icon: "💄", description: "A deep, berry-to-black lip stain with a matte finish, perfect for a classic gothic look.", ingredients: "Beeswax, Jojoba Oil, Activated Charcoal (for black) or Beetroot Powder (for deep plum)", instructions: "Melt wax and oil. Whisk in charcoal or beetroot powder until the desired 'midnight' shade is achieved. Pour into a small glass pot to set." },
    { title: "Raven's Wing Eye Coal", icon: "👁️", description: "A traditional, smudgeable cream eyeliner inspired by ancient kohl, providing a dark, dramatic frame for glasses.", ingredients: "Activated Charcoal, Shea Butter, a drop of Vitamin E Oil", instructions: "Slowly fold charcoal into softened shea butter until a thick, jet-black paste forms. Apply with a fine brush for a smokey, gothic effect." },
    { title: "Electric Prism Highlighter", icon: "🌈", description: "A multi-tonal, shimmering cream that catches the light in vibrant pinks and purples.", ingredients: "Magnesium Stearate, Cosmetic-grade Neon Micas (Pink/Purple), Fractionated Coconut Oil", instructions: "Press the micas into the magnesium stearate. Add oil drop by drop until it forms a creamy, iridescent paste. Swipe on cheekbones for a high-energy glow." },
    { title: "Neon-Flora Cheek Tint", icon: "🌸", description: "A bright, 'Electric Pink' cream blush that provides a pop of Lisa Frank-inspired color.", ingredients: "Alkanet Root Infused Oil, White Kaolin Clay, Beeswax", instructions: "Melt the wax into the infused red oil. Stir in kaolin clay to create an opaque, vibrant pink cream. Dabs on smoothly for a bold, artistic finish." },
    { title: "Cyber-Frost Eye Glaze", icon: "❄️", description: "A frosty, shimmering white-silver cream eyeshadow that perfectly captures the turn-of-the-millennium aesthetic.", ingredients: "Aloe Vera Gel, Silver Mica Powder, Vegetable Glycerin", instructions: "Whisk silver mica into the aloe gel and glycerin. The result is a cooling, holographic glaze that stays 'wet' and bright all day." },
    { title: "Millennium Glitz Lip Gloss", icon: "✨", description: "A high-shine, non-sticky clear gloss with suspended holographic glitter.", ingredients: "Castor Oil (for shine), Lanolin, Biodegradable Holographic Glitter", instructions: "Mix castor oil and lanolin until smooth. Stir in a generous amount of glitter. This provides the classic 'Y2K' shine while nourishing the skin." },
    { title: "Obsidian Armor Nail Tonic", icon: "💅", description: "A strengthening oil to keep nails resilient beneath dark or vibrant polishes.", ingredients: "Horsetail-infused Olive Oil, Lemon Essential Oil, Myrrh Resin", instructions: "Soak myrrh resin in the oil for one week. Strain and add lemon oil. Massage into cuticles daily to prevent breakage and maintain nail health." },
    { title: "Spectral Setting Mist", icon: "🌫️", description: "A lightweight spray to lock in your makeup and provide a faint, ethereal 'glow'.", ingredients: "Rose Water, Witch Hazel, a tiny pinch of Pearl Mica", instructions: "Combine in a fine-mist bottle. Shake well before each use to suspend the pearl mica, creating a 'ghostly' but beautiful finish." },
    { title: "Midnight Velvet Body Butter", icon: "🌑", description: "A thick, luxurious cream for night-time restoration, perfect for keeping skin soft during the dry Tennessee winters.", ingredients: "Mango Butter, Grapeseed Oil, Dried Hibiscus (for a deep purple tint), Vanilla Bean", instructions: "Infuse the oil with hibiscus and vanilla for 2 hours on low heat. Strain, let cool until semi-solid, then whip with mango butter until it reaches a cloud-like consistency." },
    { title: "Neon Glow Shimmer Lotion", icon: "🌈", description: "A bright, Lisa Frank-inspired body lotion that leaves a multi-tonal holographic shimmer on the skin.", ingredients: "Aloe Vera Gel, Sweet Almond Oil, Pink and Blue Eco-Glitter, Peach Essence", instructions: "Emulsify the aloe and oil by whisking vigorously. Fold in the eco-glitter and peach essence. Provides a vibrant, 'electric' glow for summer days by the pool." },
    { title: "Dasher’s Heel & Pedal Shield", icon: "👣", description: "A heavy-duty barrier balm designed specifically for the foot fatigue and dry heels caused by long delivery shifts.", ingredients: "Beeswax, Neem Oil, Peppermint Essential Oil, Arnica Infusion", instructions: "Melt beeswax and arnica oil. Add neem and peppermint. Pour into a wide tin. The arnica soothes muscle strain while the peppermint provides a cooling 'stamina boost'." },
    { title: "Graveyard Dirt Coffee Scrub", icon: "⚰️", description: "A gritty, dark-themed scrub that uses caffeine to tighten the skin and charcoal to draw out impurities.", ingredients: "Spent Coffee Grounds, Brown Sugar, Activated Charcoal, Coconut Oil", instructions: "Mix dry ingredients until the color is a uniform 'earthy' black. Fold in coconut oil until the texture resembles damp soil. Best used in the morning for a gothic wake-up call." },
    { title: "Cyber-Frost Peppermint Scrub", icon: "❄️", description: "A Y2K-inspired, tingly sugar scrub that leaves the skin feeling icy and refreshed.", ingredients: "White Sugar, Fractionated Coconut Oil, Blue Spirulina (for color), Peppermint Oil", instructions: "Blend the sugar and oil. Add a tiny pinch of blue spirulina for a 'frosted' look. The peppermint provides a sharp, metallic-cold sensation that wakes up the senses." },
    { title: "Apprentice 'Candy-Shop' Salt Scrub", icon: "🍭", description: "A gentle, colorful scrub for the kids to use after a day of outdoor play and swimming.", ingredients: "Fine Sea Salt, Jojoba Oil, Watermelon Extract, Beetroot Powder (for pink swirls)", instructions: "Divide the salt into two bowls. Tint one pink with beetroot. Layer them in a jar with jojoba oil to create a vibrant 'candy-stripe' effect." },
    { title: "Phantom Color-Shift Lip Gloss", icon: "🔮", description: "A gothic gloss that appears deep purple in the vial but shifts to a custom berry pink based on skin pH.", ingredients: "Castor Oil, Red 27 (Lip-safe color shift pigment), Gold Mica", instructions: "Mix the pigment into the castor oil until dissolved. Add a pinch of gold mica for a 'magical' sparkle. The result is a sheer, personalized tint." },
    { title: "Stardust Setting Powder", icon: "✨", description: "A lightweight, translucent powder that blurs imperfections beneath glasses and provides a matte finish.", ingredients: "Arrowroot Powder, Kaolin Clay, a pinch of French Green Clay (to neutralize redness)", instructions: "Sift the powders together through a fine mesh three times. Store in a shaker jar and apply with a large, fluffy brush to lock in your 'Raven’s Wing' eyeliner." }
];

const myHerbs = [
    { title: "Rosemary", icon: "🌿", properties: "Memory & Mental Clarity", description: "The 'Herb of Remembrance.' Burn as incense or keep fresh at your workstation to stay sharp during complex app development." },
    { title: "Gotu Kola", icon: "🍀", properties: "Cognitive Support", description: "A staple for deep focus. It helps sustain the mental energy required for long coding sessions and game design." },
    { title: "Ginkgo Biloba", icon: "🍃", properties: "Circulation & Vision", description: "Supports blood flow to the brain and eye health—essential for long hours spent looking at screens while homeschooling or dev work." },
    { title: "Sage", icon: "🍂", properties: "Wisdom & Clearing", description: "Used to clear mental fog and 'stale' energy from a workspace. Perfect for starting a new project or lesson." },
    { title: "Holy Basil (Tulsi)", icon: "🌿", properties: "Stress Resilience", description: "An adaptogen that helps the mind stay calm and centered during a chaotic schedule." },
    { title: "Peppermint", icon: "🌱", properties: "Vigilance & Digestion", description: "A bright, waking herb. Perfect as a mid-shift tea during DoorDash runs to maintain alertness and settle the stomach." },
    { title: "Nettle", icon: "🌿", properties: "Nutrient Density & Vitality", description: "Rich in iron and minerals. Brew as a nourishing infusion to maintain physical stamina through demanding Tennessee winters." },
    { title: "Ginseng", icon: "🪵", properties: "Adrenal Support", description: "A powerful adaptogen that helps the body manage stress and fatigue, keeping your energy steady across multiple tasks." },
    { title: "Oatstraw", icon: "🌾", properties: "Nervous System Support", description: "Gently restorative. Drink after a long day of driving to soothe 'road frazzle' and replenish energy." },
    { title: "Ginger", icon: "🫚", properties: "Warmth & Circulation", description: "Excellent for cold weather shifts. Keeps the inner fire burning and settles the stomach on the go." },
    { title: "Lavender", icon: "🪻", properties: "Restoration & Calm", description: "Excellent for sleep pillows and soothing teas to calm the household after a day of outdoor play." },
    { title: "Chamomile", icon: "🌼", properties: "Gentle Sleep & Ease", description: "The ultimate 'quiet time' herb. Use it to transition the apprentices from lessons to rest." },
    { title: "Lemon Balm", icon: "🍋", properties: "Bright Mood & Anxiety Relief", description: "A gentle, sunny herb that lifts the spirit. Great for reducing the stress of a busy schedule or homeschooling challenges." },
    { title: "Catnip", icon: "🐈", properties: "Relaxation (For Humans Too!)", description: "While it makes your Alinor Familiar zoomy, as a tea it is incredibly soothing for humans and helps settle restless energy." },
    { title: "Passionflower", icon: "🟣", properties: "Deep Quietude", description: "A stronger ally for those nights when the mind won't stop racing after a busy day." },
    { title: "Elderberry", icon: "🫐", properties: "Immunity & Seasonal Shield", description: "A powerful ally for the changing seasons. Brew into a syrup to ward off the winter chill." },
    { title: "Echinacea", icon: "🌸", properties: "Immune Activation", description: "Used at the first sign of a 'glitch' in your health to boost the body's natural defenses." },
    { title: "Calendula", icon: "🧡", properties: "Skin Healing", description: "A bright orange bloom used in salves to soothe skin. (Keep this in mind for our future tattoo preservation recipes!)." },
    { title: "Yarrow", icon: "🦴", properties: "Boundaries & Stopping Flow", description: "A traditional 'wound-wort.' Historically used to stop bleeding, it is also used metaphorically for energetic protection." },
    { title: "Mullein", icon: "🕯️", properties: "Breath & Air", description: "Soothing for the lungs. Excellent for clearing the chest during those damp Tennessee months." },
    { title: "Ashwagandha", icon: "🪴", properties: "Stress Adaptation & Strength", description: "A premier adaptogen. It helps your body manage the physical and mental stress of a busy schedule, keeping your 'Stamina Bar' full." },
    { title: "Dandelion Root", icon: "🌼", properties: "Detoxification & Digestion", description: "A resilient 'weed' found in every Tennessee yard. The root is a powerful ally for clearing the system and supporting steady energy." },
    { title: "Hawthorn Berry", icon: "🍒", properties: "Heart Health & Emotional Courage", description: "Supports the physical heart and provides a steadying energy when facing daunting tasks—like a complex piece of Python code." },
    { title: "Astragalus", icon: "🎋", properties: "Deep Immunity & Vitality", description: "A slow-acting but powerful tonic for the immune system. Perfect to start using as you transition into the frostfall months." }
];
...
async function buildApprenticeHTML() {
    ...
    const indoorActivities = [
        ...
        "Science Magic: Baking soda volcano.", "Indoor Scavenger Hunt.", "Scribe a collaborative story.",
        "Put on a living room play.", "Have an indoor picnic.", "DIY Instruments.", "Cardboard Engineering.",
        "Play a board game.", "Yarn Laser maze.", "Sock Skating.", "Create 'stained glass' tissue paper art.",
        "Play 'Keep the Balloon Up'.", "Life-sized self-portraits.", "Living room dance party.",
        "Hide and Seek (stuffed animal).", "Origami Hour.", "Write a letter to family.",
        "Indoor 'camping' trip.", "Simon Says.", "Mini 'store' counting coins.",
        "Make homemade playdough.", "Paper airplane contest.", "Build the tallest cup tower.",
        "Look through old photo albums.", "Quiet hour: Bardic Soundscapes."
    ];
    ...
    html += `</div>`;
    html += `<div class="section-header closed" onclick="toggleSection(this)">Milestones & Notes</div><div class="section-panel closed"><div style="margin-top: 10px; margin-bottom: 15px;"><input type="text" id="milestone-title" placeholder="Subject..." class="portal-input"><textarea id="milestone-desc" placeholder="Notes..." class="portal-input"></textarea><button onclick="addDetailedItem('apprentice_milestones', 'milestone-title', 'milestone-desc', 'apprentice')" class="portal-btn">Record Note</button></div>`;
    const milestones = await loadData('apprentice_milestones');
    milestones.forEach(item => {
        html += `<div class="alchemy-card"><h3>${item.title}</h3><p>${item.description}</p></div>`;
    });
    html += `</div></div>`;
    return html;
}
...
async function buildInventoryHTML() {
    ...
    rooms.forEach(room => {
        html += `<div class="alchemy-card" style="display:flex; justify-content:space-between; align-items:center;"><span>${room.name}</span><button class="portal-btn" onclick="loadTrophy('${room.id}', '${room.bg_url}')">Apply</button></div>`;
    });
    html += `</div><div class="section-header closed" onclick="toggleSection(this)">The Grand Stash</div><div class="section-panel closed"><input type="text" id="asset-name" placeholder="Asset Name..." class="portal-input"><input type="file" id="asset-image" accept="image/png" onchange="document.getElementById('asset-file-name').innerText = this.files[0].name"><button onclick="uploadAsset()" class="portal-btn">Store</button><div id="asset-file-name"></div><div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(70px, 1fr)); gap: 10px; margin-top: 10px;">`;
    const stash = await loadData('inventory_stash');
    stash.forEach(item => {
        html += `<div style="cursor:pointer;" onclick="spawnToForge('${item.image_url}')"><img src="${item.image_url}" style="width:100%;"></div>`;
    });
...
async function startForging(input) {
    ...
    reader.onload = async (e) => {
        ...
        if(toolbox) {
            toolbox.innerHTML = '';
            stash.forEach(item => {
                toolbox.innerHTML += `<div onclick="spawnToForge('${item.image_url}')"><img src="${item.image_url}" style="width:100%; height:40px; object-fit:contain;"></div>`;
            });
        }
...
function deleteSelected() { if(editingItem) { editingItem.remove(); editingItem = null; document.getElementById('item-controls').style.display = 'none'; } }
...
async function sealTrophy() {
    ...
    const newRoom = { name: roomName, bg_url: draftBgUrl };
...
function closePortal() {
    ...
    if (document.getElementById('bg-art')) document.getElementById('bg-art').classList.remove('dimmed');
}
...
async function bulkScribeData() {
    ...
    try {
        ...
        alert("The Master Vault is live!");
